...
#' on a permutation procedure originally prooposed by Buja and Eyuboglu 1992.
#' The function also provides an interface to the asymptotic approach proposed
